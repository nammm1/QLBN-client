...
import NutritionistSidebar from "../components/Sidebar/NutritionistSidebar";
...
const NutritionistLayout = () => {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", position: "relative" }}>
      {/* Sidebar - Desktop */}
      {!isMobile && <NutritionistSidebar collapsed={collapsed} />}
      ...
      {isMobile && (
        <Drawer
          ...
          zIndex={1001}
        >
          <NutritionistSidebar collapsed={false} onNavigate={closeMobileDrawer} />
        </Drawer>
      )}
